...
class Window
{
    ...
    */
    ...
    private static function set_x(i:Int) { if (!doReset) Lib.application.window.x = i; return i;}
    private static function set_y(i:Int) { if (!doReset) Lib.application.window.y = i; return i;}
    private static function set_width(i:Int) { if (!doReset) Lib.application.window.width = i; return i;}
    private static function set_height(i:Int) { if (!doReset) Lib.application.window.height = i; return i;}
    private static function set_title(s:String) { if (!doReset) Lib.application.window.title = s; return s;}
}