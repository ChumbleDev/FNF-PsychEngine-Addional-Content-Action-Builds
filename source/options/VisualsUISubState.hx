...
class VisualsUISubState extends BaseOptionsMenu
{
	...
	public function new()
	{
		...
		#else
		var noteSkins:Array<String> = Paths.getPath("noteSkins/list.txt", TEXT, "shared").split("\n");
		#end
		...
		#else
		var noteSplashes:Array<String> = Paths.getPath('noteSplashes/list.txt', TEXT, 'shared'.split("\n");
		#end
		...
		var option:Option = new Option('Time Bar:',
			...
			'timeBarType',
			'string',
			['Time Left', 'Time Elapsed / Length', 'Time Elapsed', 'Song Name', 'Disabled']);
		addOption(option);
